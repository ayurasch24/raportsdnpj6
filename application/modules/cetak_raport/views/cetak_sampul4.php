...
<body>
	<table>
		<tr>
			...
			DINAS PENDIDIKAN <?php echo strtoupper($this->config->item('kotaataukab')); ?> <?php echo strtoupper($this->config->item('kota_sekolah')); ?><br>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		Bekasi, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala Sekolah<br>
		<br>
		<br>
		<br>
