		...
		<tbody>
			...
			if (!empty($data_nilai)) {
				...
				foreach ($data_nilai as $d) {
					...
					// $idx0 = $pc_sangat_baik[0];
					// $idx1 = $pc_sangat_baik[1];

					// $idx00 = $list_kd[$idx0];
					// $idx11 = $list_kd[$idx1];
					// $idx22 = $list_kd[$perlu_bimbingan];
					...
					if($text_sangat_baik=="" && $text_perlu_bimbingan!=""){
						...
						$html .= '<td>'.$text_sangat_baik.'</td><td>'.$text_perlu_bimbingan.'</td><td>Sangat baik dalam ' .$text_sangat_baik.'; perlu bimbingan dalam</td></tr> '.$text_perlu_bimbingan.'. ';
					}
