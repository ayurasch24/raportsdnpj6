...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl">SDN Jaya VI</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat Sekolah</td><td>:</td><td class="tbl">Sumoroto, Sidoharjo, Samigaluh</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Bekasi Selatan, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala SDN Negeri Jaya VI <br>
							<br><br><br><br>
							<u><b>Endang Mulyaningsih, S.Pd.M.Si</b></u><br>
							NIP. 19620226 198204 2 005
						</td>
					</tr>
				</table>
