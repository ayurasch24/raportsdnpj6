...
<head>
	...
	<title>Aplikasi Penilaian Hasil Belajar Siswa</title>
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i class="pe-7s-study"></i> Sistem Informasi Penilaian Hasil Belajar Siswa
                </a>
            </div>
            <ul class="nav">
                <?php
        ...
        <footer class="footer">
            <div class="container-fluid">
                <p class="copyright pull-left">
                    <b><?php echo $this->config->item('nama_sekolah'); ?></b> | <a> Dikembangkan oleh <a> Ayura Safa Chintami </a> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger pull-right" data-dismiss="modal" onclick="return hilangkan_gambar();">Tidak tertarik, <span id="is_su"></span> dirumah lebih baik..!!</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
